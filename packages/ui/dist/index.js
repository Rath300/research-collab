...
export { Anchor, Button, Card, Checkbox, H1, H2, H3, H4, H5, H6, Image, Input, Label, Paragraph, ScrollView, Sheet, Spinner, Stack, Switch, Tabs, Text, TextArea, XStack, YStack, useTheme, } from 'tamagui';
