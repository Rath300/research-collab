    ...
    var refreshUser = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    err_1 = _a.sent();
                    console.error('Error getting current user:', err_1);
                    setError(err_1 instanceof Error ? err_1 : new Error('An unknown error occurred'));
                    return [3 /*break*/, 4];
                case 3:
                    setIsLoading(false);
                    return [7 /*endfinally*/];
    ...
    var handleSignOut = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    err_2 = _a.sent();
                    console.error('Error signing out:', err_2);
                    setError(err_2 instanceof Error ? err_2 : new Error('An unknown error occurred'));
                    return [3 /*break*/, 4];
                case 3:
                    setIsLoading(false);
                    return [7 /*endfinally*/];
