...
export function SignInForm(_a) {
    ...
    var handleSubmit = function (e) { return __awaiter(_this, void 0, void 0, function () {
        var _a, data, error_1, err_1, errorMessage;
    ...
    return (_jsxs("form", { onSubmit: handleSubmit, className: "space-y-4", children: [_jsxs("div", { children: [_jsx("label", { htmlFor: "email", className: "block text-sm font-medium", children: "Email" }), _jsx("input", { id: "email", type: "email", value: email, onChange: function (e) { return setEmail(e.target.value); }, required: true, className: "mt-1 block w-full rounded-md border-gray-300 shadow-sm" })] }), _jsxs("div", { children: [_jsx("label", { htmlFor: "password", className: "block text-sm font-medium", children: "Password" }), _jsx("input", { id: "password", type: "password", value: password, onChange: function (e) { return setPassword(e.target.value); }, required: true, className: "mt-1 block w-full rounded-md border-gray-300 shadow-sm" })] }), error && (_jsx("div", { className: "text-red-500 text-sm", children: error })), _jsx("button", { type: "submit", disabled: loading, className: "w-full py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500", children: loading ? 'Signing in...' : 'Sign in' })] }));
}
