...
var cookie = __webpack_require__(959);
...
const resolveFetch = (customFetch)=>{
    ...
    if (customFetch) {
        ...
        _fetch = (...args)=>Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 459)).then(({ default: fetch1 })=>fetch1(...args));
    } else {
        _fetch = fetch;
    }
...
var cjs = __webpack_require__(337);
...
class RealtimeClient {
     ...
     */ connect() {
        ...
        Promise.resolve(/* import() */).then(__webpack_require__.t.bind(__webpack_require__, 848, 23)).then(({ default: WS })=>{
...
const resolveResponse = ()=>helpers_awaiter(void 0, void 0, void 0, function*() {
        if (typeof Response === "undefined") {
            // @ts-ignore
            return (yield Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 459))).Response;
        }
        return Response;
    });
...
var browser = __webpack_require__(459);
...
async function middleware(request) {
    ...
    try {
        const supabase = createServerClient("https://yltnvmypasnfdgtnyhwg.supabase.co", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InlsdG52bXlwYXNuZmRndG55aHdnIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDQzNDcxNTMsImV4cCI6MjA1OTkyMzE1M30.ajCPb95af8_It1m_D4yGJhErKuLEtqqfqk8Yq2n4MCw", {
            cookies: {
                get (name) {
...
;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-middleware-loader.js?absolutePagePath=private-next-root-dir%2Fmiddleware.ts&page=%2Fmiddleware&rootDir=%2FUsers%2Fshreyansh%2FItsMightHappenApp%2Fapps%2Fweb&matchers=W3sicmVnZXhwIjoiXig%2FOlxcLyhfbmV4dFxcL2RhdGFcXC9bXi9dezEsfSkpPyg%2FOlxcLygoPyFfbmV4dFxcL3N0YXRpY3xfbmV4dFxcL2ltYWdlfGZhdmljb24uaWNvfHB1YmxpY1xcL3xhcGlcXC8pLiopKSguanNvbik%2FW1xcLyNcXD9dPyQiLCJvcmlnaW5hbFNvdXJjZSI6Ii8oKD8hX25leHQvc3RhdGljfF9uZXh0L2ltYWdlfGZhdmljb24uaWNvfHB1YmxpYy98YXBpLykuKikifV0%3D&preferredRegion=&middlewareConfig=eyJtYXRjaGVycyI6W3sicmVnZXhwIjoiXig%2FOlxcLyhfbmV4dFxcL2RhdGFcXC9bXi9dezEsfSkpPyg%2FOlxcLygoPyFfbmV4dFxcL3N0YXRpY3xfbmV4dFxcL2ltYWdlfGZhdmljb24uaWNvfHB1YmxpY1xcL3xhcGlcXC8pLiopKSguanNvbik%2FW1xcLyNcXD9dPyQiLCJvcmlnaW5hbFNvdXJjZSI6Ii8oKD8hX25leHQvc3RhdGljfF9uZXh0L2ltYWdlfGZhdmljb24uaWNvfHB1YmxpYy98YXBpLykuKikifV19!
...
// @ts-ignore
const node_fetch_1 = __importDefault(__webpack_require__(459));
const PostgrestError_1 = __importDefault(__webpack_require__(556));
...
const PostgrestQueryBuilder_1 = __importDefault(__webpack_require__(595));
const PostgrestFilterBuilder_1 = __importDefault(__webpack_require__(451));
const constants_1 = __webpack_require__(443);
/**
 * PostgREST client.
 *
...
const PostgrestTransformBuilder_1 = __importDefault(__webpack_require__(644));
...
const PostgrestBuilder_1 = __importDefault(__webpack_require__(988));
...
const version_1 = __webpack_require__(833);
...
const PostgrestClient_1 = __importDefault(__webpack_require__(319));
