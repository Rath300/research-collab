...
const ToastImplFrame = (0, import_core.styled)(import_stacks.ThemeableStack, {
  ...
  (props, forwardedRef) => {
    const {
      ...
      isPresent && (import_core.isWeb && (node != null && node.contains(document.activeElement)) && (viewport == null || viewport.focus()), onClose());
    ...
    const { useAnimatedNumber, useAnimatedNumberStyle } = animationDriver, animatedNumber = useAnimatedNumber(0), AnimatedView = animationDriver.NumberView ?? animationDriver.View, animatedStyles = useAnimatedNumberStyle(animatedNumber, (val) => {
      ...
      onPanResponderGrant: (e) => {
        import_core.isWeb || handlePause == null || handlePause();
      },
      onPanResponderMove: (e, gesture) => {
        const { x, y } = getGestureDistance(context.swipeDirection, gesture), delta = { x, y };
        animatedNumber.setValue(isHorizontalSwipe ? x : y, { type: "direct" }), isDeltaInDirection(delta, context.swipeDirection, context.swipeThreshold) && (onSwipeEnd == null || onSwipeEnd(e)), onSwipeMove == null || onSwipeMove(e);
      },
      onPanResponderEnd: (e, { dx, dy }) => {
        ...
        ) || (import_core.isWeb || handleResume == null || handleResume(), onSwipeCancel == null || onSwipeCancel(e), animatedNumber.setValue(0, { type: "spring" }));
      }
            ...
            import_dismissable.Dismissable,
            {
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_core.Theme, { forceClassName: !0, name: themeName, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                AnimatedView,
                {
                  ...
                  children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ToastProvider.Collection.ItemSlot, { __scopeCollection: __scopeToast || import_constants.TOAST_CONTEXT, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                    ToastImplFrame,
                    {
                      role: "status",
                      "aria-live": "off",
