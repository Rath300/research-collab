...
const VIEWPORT_NAME = "ToastViewport", VIEWPORT_DEFAULT_HOTKEY = ["F8"], VIEWPORT_PAUSE = "toast.viewportPause", VIEWPORT_RESUME = "toast.viewportResume", ToastViewportWrapperFrame = styled(YStack, {
  ...
  (props, forwardedRef) => {
    const {
      ...
      multipleToasts,
      ...viewportProps
    } = props, context = useToastProviderContext(__scopeToast), getItems = useCollection(__scopeToast || TOAST_CONTEXT), headFocusProxyRef = React.useRef(null), tailFocusProxyRef = React.useRef(null), wrapperRef = React.useRef(null), ref = React.useRef(null), onViewportChange = React.useCallback(
      (el) => {
    ...
    }, [getItems, getSortedTabbableCandidates, context.toastCount]), <ToastViewportWrapperFrame
      ref={wrapperRef}
      role="region"
    ...
    >
      ...
      <Collection.Slot __scopeCollection={__scopeToast || TOAST_CONTEXT}><ToastViewportFrame
