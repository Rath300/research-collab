    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 p-4">
      <div className="max-w-md w-full space-y-8 bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg">
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-600 dark:text-gray-400">Join the research collaboration network</p>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <select
                id="field"
                name="field"
                className="appearance-none block w-full px-3 py-2.5 border border-gray-300 dark:border-gray-700 rounded-lg shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
              >
