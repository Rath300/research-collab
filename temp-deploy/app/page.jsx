      ...
      <section id="features" className="w-full py-12 md:py-24 lg:py-32 bg-white dark:bg-slate-900">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 mt-12">
            {features.map(function (feature) { return (<div key={feature.title} className="flex flex-col items-center space-y-4 p-6 rounded-lg border border-gray-200 bg-white shadow-sm transition-all hover:shadow dark:border-gray-800 dark:bg-slate-800">
