...
export function getMessages(matchId_1) {
...
export function markMessagesAsRead(matchId, userId) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, error;
...
export function setupMessageListener(matchId, callback) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, subscription;
        return __generator(this, function (_a) {
            supabase = getSupabaseClient();
