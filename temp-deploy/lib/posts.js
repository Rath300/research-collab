...
export function createResearchPost(post) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, data, error;
        return __generator(this, function (_b) {
            switch (_b.label) {
...
export function updateResearchPost(id, post) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, data, error;
        return __generator(this, function (_b) {
            switch (_b.label) {
...
export function deleteResearchPost(id) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, error;
...
export function incrementEngagement(id) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, data, fetchError, currentEngagement, updateError;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    supabase = getSupabaseClient();
                ...
                case 1:
                    ...
                    currentEngagement = data.engagement_count || 0;
                    return [4 /*yield*/, supabase
                            .from('research_posts')
