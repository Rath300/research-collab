...
export var profileSchema = z.object({
    id: z.string().uuid(),
...
export var researchPostSchema = z.object({
    id: z.string().uuid(),
...
export var matchSchema = z.object({
    id: z.string().uuid(),
...
export var messageSchema = z.object({
    id: z.string().uuid(),
...
export var signUpSchema = z.object({
    ...
    agreeToTerms: z.boolean().refine(function (val) { return val === true; }, 'You must agree to the terms and conditions')
...
export var postFormSchema = z.object({
    title: z.string().min(3, 'Title must be at least 3 characters'),
    content: z.string().min(10, 'Content must be at least 10 characters'),
    tags: z.array(z.string()).optional(),
    visibility: z.enum(['public', 'private', 'connections']).default('public')
});
export var profileUpdateSchema = profileSchema.partial().omit({
    id: true,
    created_at: true,
    updated_at: true,
    joining_date: true
...
// Notification schema
export var notificationSchema = z.object({
    id: z.string(),
    user_id: z.string(),
